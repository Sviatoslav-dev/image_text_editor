...
def create_text_image(text, font_path, font_size, num):
    ...
    font = ImageFont.truetype("fonts/" + font_path + ".ttf", font_size)
    ...
    image.crop((0, 0, 50, 50)).save("fonts_data/" + font_path + f"/text_{num}_1.png")
    image.crop((50, 0, 100, 50)).save("fonts_data/" + font_path + f"/text_{num}_2.png")
    image.crop((100, 0, 150, 50)).save("fonts_data/" + font_path + f"/text_{num}_3.png")

fonts_count = 1000

for font_name in fonts:
    print(font_name)
    os.makedirs("fonts_data/" + font_name)
